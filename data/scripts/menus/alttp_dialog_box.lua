...
--Llamazing's name in dialog script.
    ...
    if self.style == "box" then
      ...
      if self.is_name then
        ...
        self.box_img:draw_region( -- right side
          ...
          x + 16 + text_width + right_offset, y - 6
        )
        self.name_surface:draw(self.dialog_surface, x + 16 + right_offset, y - 5)
      end
     end
